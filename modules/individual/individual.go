...
func MakeIndData() []int {
  indData := make([]int, IndDataFieldCount)
  for i := range indData {
    indData[i] = EmptyField
  }
  return indData
}
...
func GetStringField(field IndData) string {
  switch (field) {
    ...
    case MarriageState: return "MarriageState"
    case Lifespan: return "Lifespan"
    case Lat: return "Lat"
    case Lon: return "Lon"
    case YGens: return "YGens"
    case MtGens: return "MtGens"
    case MinGenealoGens: return "MinGenealoGens"
    case MaxGenealoGens: return "MaxGenealoGens"
    case AlleleCount: return "AlleleCount"
    case NumBlocks: return "NumBlocks"
    case NumCentromeres: return "NumCentromeres"
    case Fitness: return "Fitness"
    case NumMutations: return "NumMutations"
    case NumBirths: return "NumBirths"
    case LastBirthYear: return "LastBirthYear"
